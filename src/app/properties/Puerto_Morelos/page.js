...
function PuertoMorelosProperties() {
  ...
  useEffect(() => {
    const puertoMorelosProperties = allProperties.filter(
      p => p.ubicacion === 'Puerto Morelos'
    );

    setFilteredProperties(puertoMorelosProperties);
  }, [allProperties]);
  useEffect(() => {
  ...
  return (
    <>
      <div className="mt-24 mx-auto justify-center">
        ...
        {language === es ? es.propertiesIn : en.propertiesIn} Puerto Morelos
        </h2>
...
export default PuertoMorelosProperties;
