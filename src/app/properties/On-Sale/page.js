...
function OnSaleProperties() {
  ...
  useEffect(() => {
    const onSaleProperties = allProperties.filter(
      p => p.onsale === 'promo'
    );

    setFilteredProperties(onSaleProperties);
  }, [allProperties]);
  useEffect(() => {
  ...
  return (
    <>
      <div className="mt-24 mx-auto justify-center">
        ...
        {language === es ? es.propertiesIn : en.propertiesIn} On Sale
        </h2>
