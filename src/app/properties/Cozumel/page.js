...
function CozumelProperties() {
  ...
  useEffect(() => {
    const CozumelProperties = allProperties.filter(
      p => p.ubicacion === 'Cozumel'
    );

    setFilteredProperties(CozumelProperties);
  }, [allProperties]);
  useEffect(() => {
  ...
  return (
    <>
      <div className="mt-24 mx-auto justify-center">
        ...
        {language === es ? es.propertiesIn : en.propertiesIn} Cozumel
        </h2>
...
export default CozumelProperties;
