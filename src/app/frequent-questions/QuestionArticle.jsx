...
function QuestionArticle(props) {
  return (
    <div class="max-w-screen-xl mx-auto">
      ...
      <main class="mt-4">
        <div class="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative h-[384px]">
          <img
            src={props.image}
        ...
        <div class="px-4 lg:px-0 mt-12 text-gray-700 max-w-screen-md mx-auto text-lg leading-relaxed">
          ...
          <p class="pb-4">{props.articleP2}</p>
          <p class="pb-4">{props.articleP3}</p>
          <p class="pb-4">{props.articleP4}</p>
        </div>
      </main>
    </div>
  );
