...
const FrequentQuestionSeven = (props) => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto" id="question-7">
      <QuestionArticle
        title={language === es ? es.faq_7 : en.faq_7}
        image="https://images.pexels.com/photos/8293651/pexels-photo-8293651.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        capitalLetter={language === es ? es.faq_7_article.cap_letter_p1 : en.faq_7_article.cap_letter_p1}
        articleP1={language === es ? es.faq_7_article.p1 : en.faq_7_article.p1}
