...
const FrequentQuestionTwo = (props) => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto" id="question-2">
      <QuestionArticle
        title={language === es ? es.faq_info.faq_2 : en.faq_info.faq_2}
        image="https://images.pexels.com/photos/8470844/pexels-photo-8470844.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        capitalLetter={language === es ? es.faq_info.faq_2_article.cap_letter_p1 : en.faq_info.faq_2_article.cap_letter_p1}
        articleP1={language === es ? es.faq_info.faq_2_article.p1 : en.faq_info.faq_2_article.p1}
        articleP2=""
