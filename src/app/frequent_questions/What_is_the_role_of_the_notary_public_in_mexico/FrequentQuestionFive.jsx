...
const FrequentQuestionFive = (props) => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto" id="question-5">
      <QuestionArticle
        title={language === es ? es.faq_info.faq_5 : en.faq_info.faq_5}
        ...
        capitalLetter={language === es ? es.faq_info.faq_5_article.cap_letter_p1 : en.faq_info.faq_5_article.cap_letter_p1}
        articleP1={language === es ? es.faq_info.faq_5_article.p1 : en.faq_info.faq_5_article.p1}
