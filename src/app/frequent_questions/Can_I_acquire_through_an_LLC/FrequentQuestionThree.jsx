...
const FrequentQuestionThree = (props) => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto" id="question-3">
      <QuestionArticle
        title={ language === es ? es.faq_info.faq_3 : en.faq_info.faq_3}
        image="https://images.pexels.com/photos/8636603/pexels-photo-8636603.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        capitalLetter={ language === es ? es.faq_info.faq_3_article.cap_letter_p1 : en.faq_info.faq_3_article.cap_letter_p1}
        articleP1= {language === es ? es.faq_info.faq_3_article.p1 : en.faq_info.faq_3_article.p1}
        articleP2=""
