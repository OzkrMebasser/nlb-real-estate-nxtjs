...
const FrequentQuestionEight = (props) => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto" id="question-8">
      <QuestionArticle
        title={language === es ? es.faq_info.faq_8 : en.faq_info.faq_8}
        image="https://images.pexels.com/photos/8815873/pexels-photo-8815873.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        capitalLetter={language === es ? es.faq_info.faq_8_article.cap_letter_p1 : en.faq_info.faq_8_article.cap_letter_p1}
        articleP1={language === es ? es.faq_info.faq_8_article.p1 : en.faq_info.faq_8_article.p1}
