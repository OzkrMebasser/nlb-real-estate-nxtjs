...
const FrequentQuestionSix = (props) => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto" id="question-6">
      <QuestionArticle
        title={language === es ? es.faq_6 : en.faq_6}
        image="https://images.pexels.com/photos/3943748/pexels-photo-3943748.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        capitalLetter={language === es ? es.faq_6_article.cap_letter_p1: en.faq_6_article.cap_letter_p1}
        articleP1={language === es ? es.faq_6_article.p1 : en.faq_6_article.p1}
        articleP2={language === es ? es.faq_6_article.p2 : en.faq_6_article.p2}
        articleP3={language === es ? es.faq_6_article.p3 : en.faq_6_article.p3}
