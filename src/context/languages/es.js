const esTranslations = {
  ...
  hero: {
    ...
    labelHero_1: "PRE-VENTAS",
    labelHero_2: "TERRENOS DE INVERSION",
    labelHero_3: "ENTREGA INMEDIATA",
    labelHero_4: "LLAVE EN MANO",
    labelHero_5: "CONDO HOTELERO",
    labelHero_6: "UNIDADES EN PROMOCIÓN",
  },
  ...
  pom: {
    nalu: {
      ...
      //Unidades Tipologia
      unit_1: {
        unit_1_Title: "2 HABITACIONES CON VISTA AL MAR O FRENTE A LA PLAYA",
        unit_1_description:
          "NÁLU, es un desarrollo de lujo en Puerto Morelos de 12 apartamentos frente a la playa diseñados bajo una filosofía de confort y respeto al entorno integrando amenidades para disfrutar de la naturaleza y aportar bienestar a un estilo de vida único al vivir frente al mar del caribe mexicano",
        unit_1_amenidades: {
          amenidad_1: "Playa Privada",
          amenidad_2: "Área de Barbacoa",
          amenidad_3: "Bar en la Piscina",
          amenidad_4: "Vestíbulo",
          amenidad_5: "Ascensor",
          amenidad_6: "Piscina en la Azotea",
          amenidad_7: "Seguridad las 24 horas, los 7 días de la semana",
          amenidad_8: "",
        },
      },
      unit_2: {
        unit_2_Title: "PENTHOUSE 3 HABITACIONES FRENTE A LA PLAYA",
        unit_2_description:
          "NÁLU, es un desarrollo de lujo en Puerto Morelos de 12 apartamentos frente a la playa diseñados bajo una filosofía de confort y respeto al entorno integrando amenidades para disfrutar de la naturaleza y aportar bienestar a un estilo de vida único al vivir frente al mar del caribe mexicano",
